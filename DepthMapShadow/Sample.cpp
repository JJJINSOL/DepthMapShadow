...
bool Sample::LoadMap()
{
	...
	m_MapObj.CreateHeightMap(L"../../data/heightMap513.bmp");
	m_MapObj.CreateMap(m_MapObj.m_iNumCols, m_MapObj.m_iNumRows, 10.0f);
	if (!m_MapObj.Create(m_pd3dDevice.Get(), m_pImmediateContext.Get(),L"MapRT.hlsl",L"../../data/002.jpg"))
	{
		return false;
	}
...
bool Sample::LoadFbx()
{
	...
	T::LoadAllPath(L"../../data/Meshes", listname);
...
bool Sample::Init()
{
	...
	m_pNormalMap = I_Texture.Load(L"../../data/tileADOT3.jpg");
